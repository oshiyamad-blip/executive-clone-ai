...
| トンマナ | A 準拠 ／ B 生成り＋金 ／ C ダーク ／ D 明朝 ／ E 丸ゴシック ／ **F 紺×ライム** ／ **G 白と朱** |
| 表示 | PC ／ スマホ |
...
**トンマナ**は7案。A〜E は既存サイトの3色（黒・金・生成り）の枠内、
**F・G はその枠を外して「まっさらから考えるなら」で組んだ案**で、新しい色を使う。
D と E は和文書体そのものを替えるため、本番でも対応する Google Fonts の読み込みが要る。
考え方・各案の狙い・参考サイトは `docs/07-tone-references.md`。
