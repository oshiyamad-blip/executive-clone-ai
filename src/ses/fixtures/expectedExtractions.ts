...
export const EXPECTED_EXTRACTIONS: Record<string, ExtractedItem[]> = {
  ...
  // E5: ルールでは P2 の成立候補（粗利15万円）だが、P2 の商流メモ「50歳まで」に反するため最終判定で不適合になる
  sesmail_demo_e5: [
    {
      kind: 'engineer',
      engineer: {
        ...
        utilization: '週5',
        remoteWish: 'none',
        agentCompany: '株式会社カッパシステム',
        agentContact: '小林九郎',
        agentEmail: 'kobayashi@kappasys.example.jp',
        sourceMailId: 'sesmail_demo_e5',
        receivedAt: demoReceivedAt('2026-07-16T16:00:00+09:00'),
        status: 'available',
      },
    },
  ],
